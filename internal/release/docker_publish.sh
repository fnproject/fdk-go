...
{
  $REGCTL_BIN image copy iad.ocir.io/oraclefunctionsdevelopm/fnproject/go:1.20 docker.io/fnproject/go:1.20;
  $REGCTL_BIN image copy iad.ocir.io/oraclefunctionsdevelopm/fnproject/go:1.20-dev docker.io/fnproject/go:1.20-dev;
