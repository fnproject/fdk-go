...
GITHUB_REMOTE=git@github.com:fnproject/fdk-go.git
BITBUCKET_REMOTE=ssh://git@bitbucket.oci.oraclecorp.com:7999/faas/fdk-go.git
PUBLISH_BRANCH=github
TARGET_BRANCH=master
GIT_USER_EMAIL=ci@fnproject.com
GIT_USER_NAME=CI
SSH_KEY_SECRET=ocid1.vaultsecret.oc1.phx.amaaaaaaepf6idiapspou7yo7sgl4b5gmdt4vqjnbnvrlagx67rbxyfkzeyq
